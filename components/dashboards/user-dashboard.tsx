    ...
    <div className="space-y-6">
            ...
            <DialogContent className="sm:max-w-[525px]">
              ...
              <DialogFooter>
                ...
                <Button onClick={() => {
                  ...
                  const type = 'report' // Default, should get from select
                  handleCreateDocument({ title, description, type })
                }}>
                  Create Document
                </Button>
              </DialogFooter>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="text-primary" onClick={() => router.push('/documents')}>
              View All
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="text-primary" onClick={() => router.push('/workflows')}>
              View All
              <ArrowUpRight className="w-4 h-4 ml-1" />
            </Button>
          </CardHeader>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button variant="ghost" size="sm" className="text-primary" onClick={() => router.push('/case-files')}>
            View All
            <ArrowUpRight className="w-4 h-4 ml-1" />
          </Button>
        </CardHeader>
