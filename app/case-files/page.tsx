...
export default function CaseFilesPage() {
  ...
  const handleCreateCaseFile = async (formData: any) => {
    ...
    console.log('🔧 Creating case file with data:', formData)
    ...
    try {
      ...
      console.log('📤 Sending case file data:', caseFileData)
      ...
      console.log('📥 Case file response status:', response.status)
      
      if (response.ok) {
        const data = await response.json()
        console.log('📥 Case file response data:', data)
        ...
        const data = await response.json()
        console.error('❌ Case file creation failed:', data)
...
Owner: ${caseFile.owner?.fullName || caseFile.owner?.firstName + ' ' + caseFile.owner?.lastName || 'Unknown'}
  ...
  const handleDeleteCaseFile = async (caseFile: any) => {
    ...
    console.log('🗑️ Deleting case file:', caseFile._id)
